...
if(isset($_SESSION['login_gmt']))
{
	...
	$solicitudes=mysqli_query($con, "SELECT solicitud.id, cliente.nombre as cliente, solicitud.clave,presupuesto.nombrePpto,
	solicitud.aplica, solicitud.fecha, solicitud.mesqaplica,solicitud.importe, solicitud.desgloce, solicitud.cuenta,
	solicitud.formaPago, solicitud.concepto, solicitud.solicita, solicitud.autorizado
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
									<table class="table table-striped" id="datatable_1">
										...
										?>
											<tr>
												<td><a href="dat.php?idmc=<?php echo $fila["id"];?>"><?php echo $fila["id"];?></a></td>
