...
if(isset($_SESSION['login_gmt']))
{
	...
	$exis_candidatos=mysqli_query($con, "SELECT vacantes.*, puestos.puesto AS tipo_solicitud FROM vacantes INNER JOIN puestos ON vacantes.tipo_encuesta = puestos.id;");
?>
<!DOCTYPE html>
										...
										<table class="table" id="datatable_1">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href="#" ><?php echo $fila ["tipo_solicitud"]; ?></a></td>
													<?php if ($fila ["status"] == 'activo') {
													?>
														<td style="background-color: green;" align="center"><a href="javascript:;" style="color: white;"><?php echo $fila ["status"]; ?></a></td>	
													<?php
													}else{?>
														<td style="background-color: red;" align="center"><a href="javascript:;" style="color: white;"><?php echo $fila ["status"]; ?></a></td>	
													<?php
													} ?>
													<td align="center"><a href="editar_vacante.php?id=<?php echo $fila["id"];?>"><i class="las la-pen text-secondary font-16"></i></a></td>
												</tr>
											<?php
											}
											?>  
