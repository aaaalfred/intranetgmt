                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
								...
								<p>Carga tus altas a nuestro servidor</p>
                            </div><!--end card-header-->
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="dropdone-nk mg-t-30" align="center">
										<div class="cmp-tb-hd">
											<h2>Subir Archivo de altas</h2>
										</div>
										<form method="POST" action="actions/updocaltas.php" enctype="multipart/form-data">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="form-group">
													<div class="nk-int-st">
														<br>
														<label>Selecciona un tu archivo de altas a cargar</label>
