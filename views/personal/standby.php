...
if(isset($_SESSION['login_gmt']))
{
	...
	//$query_usuarios = mysqli_query($con,"SELECT usuarios.* FROM usuarios WHERE estatus = 'Inactivo' AND ".$query_claves." ORDER BY fechaAlta DESC;");
	$query_usuarios = mysqli_query($con,"SELECT usuarios.* FROM usuarios WHERE estatus = 'Inactivo' ORDER BY fechaAlta DESC;");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Stand-By </h4>
                            </div><!--end card-header-->
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td>
													...
													<a href="perfil.php?id=<?php echo $fila ['id'];?>&curp=<?php echo $fila ['curp'];?>&vista=standby"><i class="las la-pen text-secondary font-16"></i></a>
												</td>
                                            </tr> 
											<?php  
												}
