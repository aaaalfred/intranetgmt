...
if(isset($_SESSION['login_gmt']))
{
	...
	$exis_candidatos=mysqli_query($con, "SELECT idPpto,altaPpto,nombrePpto,archivoPpto,clavePpto, pdf, credenciales.nombre FROM presupuesto, credenciales WHERE idUser=credenciales.id;");
?>
<!DOCTYPE html>
                                ...
                                <div class="table-responsive">
									<table class="table table-striped" id="datatable_1">
										...
										?>
											...
											<td><a href="<?php echo $fila["archivoPpto"];?>" ><?php echo $fila ["clavePpto"]; ?></a></td>
											<td><a href="<?php echo $fila["pdf"];?>" target="_blank"><?php echo $fila ["pdf"]; ?></a></td>
											<td><?php echo $fila ["nombre"]; ?></td>
											<td><a href="anexo.php?clavePpto=<?php echo $fila["clavePpto"];?>"><i class="fa fa-arrow-right"></i></a></td>
										</tr>
										<?php
										}
										?> 
