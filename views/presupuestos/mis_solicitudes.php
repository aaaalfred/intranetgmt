...
if(isset($_SESSION['login_gmt']))
{
	...
	$solicitudes=mysqli_query($con, "SELECT solicitud.autorizado, solicitud.id, cliente.nombre as cliente, solicitud.clave,presupuesto.nombrePpto,
	...
	FROM solicitud INNER JOIN cliente, presupuesto, credenciales
	WHERE credenciales.id= '".$_SESSION["id_gmt"]."' and solicitud.clave=presupuesto.clavePpto 
	and solicitud.idCliente=cliente.id 
