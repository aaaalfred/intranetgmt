...
if(isset($_SESSION['login_gmt']))
{
	...
	if(empty($_POST['codsel'])){
		$query_usuarios = mysqli_query($con,"SELECT usuarios.* FROM usuarios WHERE autorizado = 1 AND autorizado_dos IS NULL AND ".$query_claves." ORDER BY fechaAlta DESC;");
	}else{
		$query_usuarios = mysqli_query($con,"SELECT usuarios.* FROM usuarios WHERE autorizado = 1 AND autorizado_dos IS NULL ".$condicion_claves." ORDER BY fechaAlta DESC;");
	}
							...
							<div class="row"> 
									<div class="col-lg-8">
										<div class="card">
											...
											<form method="POST" action="preaprobados.php?filtro=true">
												<div class="card-body">
													<div class="row">
														<div class="col-md-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td>
													...
													<a href="perfil.php?id=<?php echo $fila ['id'];?>&curp=<?php echo $fila ['curp'];?>&vista=preaprobados"><i class="las la-pen text-secondary font-16"></i></a>
												</td>
                                            </tr> 
											<?php  
												}
