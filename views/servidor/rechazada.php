                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td class="content-block" style="padding: 0 0 20px;" valign="top">
                                                                <h2 class="aligncenter" style="font-size: 24px; color:#98a2bd; line-height: 1.2em; font-weight: 600; text-align: center;" align="center">HA SIDO RECHAZADA LA SOLICITUD<span style="color: #4d79f6; font-weight: 700;"> #'.$nodesolicitud.'</span></h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
									...
									<div class="col-sm-12 col-md-12">
										...
										<div class="col-md-4">
											<div class="alert alert-danger">
												<i class="fa fa-check sign"></i><strong> NO AUTORIZADA!</strong><h3>SOLICITUD <?php echo $reg_visita ["id"]?></h3>
											</div>
										</div>
										<div class="col-md-4">
										</div>
