...
if(isset($_SESSION['login_gmt']))
{
	...
	$exis_candidatos=mysqli_query($con, "SELECT postulaciones.id,postulaciones.alta, postulaciones.id_rh, postulaciones.vacante,nombre,ap,am, rh.cel, rh.tel, rh.correo, rh.edo, rh.delomun, rh.edad FROM postulaciones INNER JOIN rh ON postulaciones.id_rh= rh.id GROUP BY postulaciones.id_rh order by postulaciones.alta desc;");
?>
<!DOCTYPE html>
									...
									<div class="table-responsive">
										<table class="table" id="datatable_1">
											...
											<tbody>
												...
												?>
												<tr>
												<td><a href="javascript:;"><?php echo $fila ["alta"]; ?></a></td>
													<td><a href="javascript:;"><?php echo $fila ["id"]; ?></a></td>
													<td><a href="javascript:;" ><?php echo $fila ["nombre"]," ",$fila ["ap"]," ",$fila ["am"]; ?></a></td>
													<td><a href="javascript:;" ><?php echo $fila ["cel"],"<br>",$fila ["tel"],"<br>",$fila ["correo"]; ?></a></td>
													<td><a href="javascript:;" ><?php echo $fila ["edo"],"-",$fila ["delomun"]; ?></a></td>
													<td><a href="javascript:;" ><?php echo $fila ["edad"]; ?></a></td>
													<td align="center"><a href="perfil_user.php?idmc=<?php echo $fila["id_rh"];?>"><i class="fa fa-search"></i></a></td>
												</tr>
											<?php
											}
											?>  
