...
if(isset($_SESSION['login_gmt']))
{
	...
	$query_usuarios = mysqli_query($con,"SELECT usuarios.* FROM usuarios WHERE curp = '".$_POST['bcurp']."' ORDER BY fechaAlta DESC;");
...
<html lang="en" dir="ltr">
    <head>
		...
		<link href="<?php echo $views;?>../assets/libs/huebee/huebee.min.css" rel="stylesheet" type="text/css" />
    ...
    <body id="body">
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Buscar CURP </h4>
									<span >Resultados de la curp: <?php echo $_POST['bcurp']; ?> </span>
								</div><!--end card-header-->
								<div class="card-body">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<a href="perfil.php?id=<?php echo $fila ['id'];?>&curp=<?php echo $fila ['curp'];?>&vista=search"><i class="las la-pen text-secondary font-16"></i></a>
													</td>
												</tr> 
												<?php  
													}
        ...
        <script src="<?php echo $views;?>../assets/libs/huebee/huebee.pkgd.min.js"></script>
        
        <script src="<?php echo $views;?>../assets/js/moment.js"></script>
        <script src="<?php echo $views;?>../assets/libs/imask/imask.min.js"></script>
        <!-- App js -->
