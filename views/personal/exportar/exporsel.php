<?php
	...
	$string_claves = implode(",", $_POST['seleccionados']);
	
	$query_claves = "id IN (".$string_claves.") ";
	
	
	
	if($_POST['modulo'] === "Candidatos"){
