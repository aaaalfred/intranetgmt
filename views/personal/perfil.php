                                ...
                                <div class="tab-content">
									...
									<div class="tab-pane p-3" id="Contrato" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
												<div id="grid" class="row g-0">
													<?php while ($fila=mysqli_fetch_array($query_contrato)){ ?>
													<div class="col-md-4 col-lg-3 picture-item">
													
														<?php 
															$porciones = explode("/", $fila['contrato']);
															$extensiondoc = explode(".", $porciones[4]);
															if($extensiondoc[1] == "pdf"){
															?>
															<embed src="http://72.167.45.26<?php echo $fila['contrato']; ?>" type="application/pdf" width="100%" height="475px" />
															<br><br>
															<a href="eliminar_contrato.php?id=<?php echo $fila['id']?>&tipo=<?php echo $vista; ?>&curp=<?php echo $fila['curp']; ?>" class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i></a>
															<a class="btn btn-warning" href="javascript:historico(<?php echo $fila['id'] ?>,'<?php echo $fila['curp']; ?>', 'contrato')"><i class="fa fa-bookmark"></i></a>
															<?php
															}else{
														  ?>
															  <img src="http://72.167.45.26<?php echo $fila['contrato']; ?>" class="img-fluid">
															  <br><br>
															  <div align="center">
																<a href="eliminar_contrato.php?id=<?php echo $fila['id']?>&tipo=<?php echo $vista; ?>&curp=<?php echo $fila['curp']; ?>" class="btn btn-danger"><i class="fa fa-window-close" aria-hidden="true"></i></a>
																<a class="btn btn-warning" href="javascript:historico(<?php echo $fila['id'] ?>,'<?php echo $fila['curp']; ?>', 'contrato')"><i class="fa fa-bookmark"></i></a>
