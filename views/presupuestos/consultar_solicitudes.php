                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
								...
								<p>Selecciona el rando de fechas en el que deseas consultar</p>
                            </div><!--end card-header-->
							<div class="row">
								<div class="col-md-4">
								</div>
								<div class="col-md-4" align="center">
									<div class="nk-cd-ed-wp">
										...
										<form class="form-horizontal group-border-dashed" method="post" action="tipo_consulta.php" style="border-radius: 0px;">
											<div class="form-group">
												<label class="col-sm-3 control-label">Inicio</label>
												<div class="col-sm-6">
													<input  class="form-control"size="16" type="date" name="fechai" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">Fin</label>
												<div class="col-sm-6">
													<input class="form-control" size="16" type="date" name="fechaf" />
												</div>
											</div>
											<br>
											<div align="center">
												<button name="enviar" class="btn btn-primary" type="submit" value="enviar">Enviar</button>
												<button name="enviar" class="btn btn-default" type="submit" value="excel">Exportar</button>
											</div>
											<br>
										</form>
									</div>
