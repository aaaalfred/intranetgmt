        ...
        <div class="page-wrapper">
            ...
            <div class="page-content-tab">
				<div class="row">
                    <div class="col-lg-12">
                        <div class="card">
							<form method="POST" action="insertar_ejecutivo.php">
								<div class="card-header">
									<h4 class="card-title">Agregar ejecutivo</h4>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<div class="mb-3 row">
													<label class="col-sm-2 col-form-label text-end">ROL</label>
													<div class="col-sm-10">
														<select class="form-select" name="rol" aria-label="Default select example">
															<option value="A">EJECUTIVO A</option>
															<option value="B">EJECUTIVO B</option>
															<option value="GROUPER">EJECUTIVO GROUPER</option>
														  </select>
													</div>
												</div>
											<div class="mb-3 row">
