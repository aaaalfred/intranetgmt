...
<head>
    <meta charset="utf-8" />
    <title>Liberación de Contratos</title>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Liberación de Contratos</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Contratos en Proceso</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="perfil.php?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-soft-primary">Ver</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
