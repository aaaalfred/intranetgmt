                ...
                <div class="menu-body navbar-vertical tab-content" data-simplebar>
                    <div id="MetricaInicio" class="main-icon-menu-pane tab-pane" role="tabpanel"
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo $views;?>index.php">Inicio</a>
                            </li><!--end nav-item-->
                        </ul><!--end nav-->
                    </div><!-- end Dashboards -->
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse " id="sidebarCrypto">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?php echo $views;?>personal/mipersonal.php">Mi personal</a>
                                            </li><!--end nav-item-->
                                            <li class="nav-item">
