...
if(isset($_SESSION['login_gmt']))
{
	...
	//$fila=mysqli_fetch_array($num_registros);

	$clave=$_SESSION["clave_cliente"];
	$clavepadre=$_SESSION["clave_padre"];
				...
				<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
										<div align="center">
												<form class="form-horizontal group-border-dashed" method="post" action="upload_anexo.php" enctype="multipart/form-data">
